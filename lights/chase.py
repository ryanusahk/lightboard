...
while True:
    ...
    color_chase(RED, 0.025)  # Increase the number to slow down the color chase
    color_chase(YELLOW, 0.025)
    color_chase(GREEN, 0.025)
    color_chase(CYAN, 0.025)
    color_chase(BLUE, 0.025)
    color_chase(PURPLE, 0.025)
    color_chase(WHITE, 0.025)
 	# rainbow_single(0.01)
